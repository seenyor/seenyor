...
const SetPassword = () => {
  ...
  return (
    <div className="flex flex-col gap-[1.88rem] h-screen w-full justify-center items-center">
      <form onSubmit={handleSetPassword} className="flex flex-col items-start gap-[0.75rem] w-[40%] tab:w-[90%]  md:items-center">
        <Heading size="heading7xl" as="h1" className="font-bold text-text">Create New Password</Heading>
        <Text as="p" className="text-[1.13rem] font-medium capitalize pb-[1.6rem] md:text-center  ">Please create a strong password with a minimum of eight digits.</Text>
